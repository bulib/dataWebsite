...
According the the Registry of Research Data Repositories ([re3data.org](http://www.re3data.org/)) and <suggestion: missing word?>> data repository is a
...
* Figshare - [Figshare](https://figshare.com/) is a part of the [Digital Science](https://www.digital-science.com/) portfolio of services. Although only some of Figshare's services are free to users, it's business model also includes working with institutions, publishers, and researchers to fund its data repository. [Since 2012](https://figshare.com/about) Figshare had 800,000 user uploads, 7.5 millon downloads, over 26 million page views. <<suggestion: Is it 'since' or in 2012?>>
